import { pgTable, text, serial, integer, boolean, timestamp, doublePrecision, date, jsonb, varchar } from "drizzle-orm/pg-core";
...
export const users = pgTable("users", {
  ...
  role: text("role", { enum: ["client", "manager", "admin"] }).default("client"),
