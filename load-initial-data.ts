...
const { contacts, deals, dealStages, insertContactSchema, insertDealSchema, insertDealStageSchema } = schema;

// Define types for our data
type InsertContact = typeof insertContactSchema._type;
type InsertDeal = typeof insertDealSchema._type;
type InsertDealStage = typeof insertDealStageSchema._type;
...
async function loadInitialData() {
  ...
  try {
    ...
    const stageNames = Array.from(stageSets) as string[];
